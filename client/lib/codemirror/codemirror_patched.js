...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    if (place.document) {
        var window = place.document.defaultView;
        var document = place.document;
    }
  ...
  CodeMirror.fromTextArea = function(textarea, options) {
    ...
    function creationCallback(node) {
      textarea.parentNode.insertBefore(node, textarea.nextSibling);
    }
    creationCallback.document = textarea.ownerDocument;
    var instance = CodeMirror(creationCallback, options);
    instance.save = save;
  ...
  function connect(node, type, handler, disconnect) {
    if (typeof node.addEventListener == "function") {
      ...
      var wrapHandler = function(event) {handler(event || node.ownerDocument.defaultView.event);};
  ...
  function computedStyle(elt) {
    ...
    return elt.ownerDocument.defaultView.getComputedStyle(elt, null);
  }
